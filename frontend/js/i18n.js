...
const ESTICC_STRINGS = {
  ...
  es: {
    ...
    radar: {
      cargando:              'Actualizando Radar OSINT…',
      error_fetch:           'Error al obtener noticias',
      error_corr:            'Error en correlación',
      guardar_pdf:           '🖨️ Guardar PDF',
      informe_titulo:        'Informe OSINT Semanal',
      alertas_criticas:      'Alertas críticas',
      alertas_altas:         'Alertas altas',
      noticias_revisadas:    'Noticias revisadas',
      sin_amenazas:          'Sin amenazas relevantes',
      noticias_sin_coincidencia: 'noticias analizadas sin coincidencias con tu sistema.',
      puerto_expuesto:       'Puerto expuesto detectado',
      vulnerabilidad:        'Vulnerabilidad publicada',
      sin_alertas_correlacion: 'Sin alertas de correlación',
      alertas_correlacion:   'Alertas de correlación',
      sec_criticas:          'Amenazas Críticas esta semana',
      sec_altas:             'Amenazas de Alto Riesgo esta semana',
      sec_info:              'Noticias Informativas esta semana',
      sin_noticias_semana:   'No se encontraron noticias de los últimos 7 días.',
      ultimas_disponibles:   'mostrando las más recientes disponibles',
      mas_noticias:          'más noticias',
      fuentes:               'fuentes',
      noticias_analizadas:   'noticias analizadas',
  ...
  en: {
    ...
    radar: {
      cargando:              'Updating OSINT Radar…',
      error_fetch:           'Error fetching news',
      error_corr:            'Correlation error',
      guardar_pdf:           '🖨️ Save PDF',
      informe_titulo:        'Weekly OSINT Report',
      alertas_criticas:      'Critical alerts',
      alertas_altas:         'High alerts',
      noticias_revisadas:    'News reviewed',
      sin_amenazas:          'No relevant threats',
      noticias_sin_coincidencia: 'news items analyzed with no matches on your system.',
      puerto_expuesto:       'Exposed port detected',
      vulnerabilidad:        'Published vulnerability',
      sin_alertas_correlacion: 'No correlation alerts',
      alertas_correlacion:   'Correlation alerts',
      sec_criticas:          'Critical Threats this week',
      sec_altas:             'High-Risk Threats this week',
      sec_info:              'Informational News this week',
      sin_noticias_semana:   'No news found from the last 7 days.',
      ultimas_disponibles:   'showing most recent available',
      mas_noticias:          'more news',
      fuentes:               'sources',
      noticias_analizadas:   'news analyzed',
